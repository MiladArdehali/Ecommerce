...
class appDevDebugProjectContainer extends Container
{
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_mysql', 'host' => '127.0.0.1', 'port' => 3306, 'dbname' => 'ecommerce', 'user' => 'root', 'password' => NULL, 'charset' => 'UTF8', 'driverOptions' => array(), 'defaultTableOptions' => array()), $b, new \Symfony\Bridge\Doctrine\ContainerAwareEventManager($this), array());
    }
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService($lazyLoad = true)
    {
        ...
        $a->addDriver(new \Doctrine\ORM\Mapping\Driver\AnnotationDriver($this->get('annotation_reader'), array(0 => ($this->targetDirs[3].'\\src\\EcommerceBundle\\Entity'))), 'EcommerceBundle\\Entity');

        $b = new \Doctrine\ORM\Configuration();
        $b->setEntityNamespaces(array('EcommerceBundle' => 'EcommerceBundle\\Entity'));
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf2orm_default_b9d1dfb80bb39983540fec74386e86709dd0ce1d97f2cde2a965fdc6657cf04f');
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath(($this->targetDirs[3].'\\src\\EcommerceBundle/Resources/views'), 'Ecommerce');
        $instance->addPath(($this->targetDirs[3].'\\src\\PagesBundle/Resources/views'), 'Pages');
    ...
    {
        $this->services['security.authentication.manager'] = $instance = new \Symfony\Component\Security\Core\Authentication\AuthenticationProviderManager(array(0 => new \Symfony\Component\Security\Core\Authentication\Provider\AnonymousAuthenticationProvider('58fd10839d88a4.37231952')), true);
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'kernel.bundles' => array(
                ...
                'EcommerceBundle' => 'EcommerceBundle\\EcommerceBundle',
                'PagesBundle' => 'PagesBundle\\PagesBundle',
            ...
            'kernel.bundles_metadata' => array(
                ...
                'EcommerceBundle' => array(
                    'parent' => NULL,
                    'path' => ($this->targetDirs[3].'\\src\\EcommerceBundle'),
                    'namespace' => 'EcommerceBundle',
                ),
                'PagesBundle' => array(
                    'parent' => NULL,
                    'path' => ($this->targetDirs[3].'\\src\\PagesBundle'),
                    'namespace' => 'PagesBundle',
                ),
                'DebugBundle' => array(
                    'parent' => NULL,
